...
// system (D1). cli.ts traces this so `CTX_DEBUG` can answer "why wasn't this
...
//   - tty-no-flag: stdout is a TTY and CTX_COMPRESS_TTY is not set
...
// NOT a TTY — UNLESS `CTX_COMPRESS_TTY` opts this terminal in (R1: VS Code Copilot's
...
export function gateDecision(
  ...
  const forceCompress = Boolean(process.env.CTX_COMPRESS_TTY);
