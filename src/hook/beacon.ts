// Issue #42 — optional "ctx active" routing beacon.
//
...
// So a transcript reader cannot positively confirm "ctx fired" — firing is inferred
...
//
// This emits ONE line of `additionalContext` ("ctx active …") on a rewrite so a
// transcript inspection can confirm firing directly. It is OPT-IN behind
// `CTX_HOOK_BEACON` and only ever ADDS `additionalContext` to a decision the host
...
// the transcript shows WHICH command ctx wrapped. Total; never throws.
